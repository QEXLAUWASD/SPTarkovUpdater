...
class PMCs {
    ...
    databaseServer;
    profileHelper;
    modConfig = require("../config/pmc.json");
    constructor(botConfig, pmcConfig, databaseServer, profileHelper) {
    ...
    generatePmcs() {
        ...
        const faceCoverLL3 = faceCoverLL2.concat(...["5ab8f85d86f7745cd93a1cf5", "5b432f3d5acfc4704b4a1dfb"]);
        const faceCoverLL4 = [
        ...
        const progressionWhitelistLL1PMC = {
            weaponModLimits: {
                scopeLimit: 1,
                lightLaserLimit: 1,
            },
        ...
        const progressionWhitelistLL2PMC = {
            levelRange: {
                min: lvl.loyalty2.min,
                max: lvl.loyalty2.max,
            },
        ...
        const progressionWhitelistLL2PMCWide = {
            levelRange: {
                min: lvl.loyalty2.min,
                max: lvl.loyalty2.max,
            },
        ...
        const progressionWhitelistLL3PMC = {
            levelRange: {
                min: lvl.loyalty3.min,
                max: lvl.loyalty3.max,
            },
        ...
        const progressionWhitelistLL3PMCWide = {
            levelRange: {
                min: lvl.loyalty3.min,
                max: lvl.loyalty3.max,
            },
        ...
        const progressionWhitelistLL4PMC = {
            levelRange: {
                min: lvl.loyalty4.min,
                max: 100,
            },
        ...
        const progressionWhitelistLL4PMCWide = {
            levelRange: {
                min: lvl.loyalty4.min,
                max: 100,
            },
